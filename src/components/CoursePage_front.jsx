...
export default function CoursePageFront({
  courses, loading, loadError, likes, weatherBanner, sheetOpen, conditions, generating, genError, canGenerate, toast,
  ...
  return (
    <div style={{ background: '#F6F7F3', minHeight: '100%' }}>
      ...
      {sheetOpen && (
        <AiCourseSheet
          conditions={conditions} generating={generating} error={genError} canGenerate={canGenerate}
